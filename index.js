...
fetch(
  "https://api.bart.gov/api/etd.aspx?cmd=etd&orig=24th&key=MW9S-E7SL-26DU-VV8V&json=y"
)
  ...
  .then(function(myJson) {
    ...
    let timesEB =
      '<h2>Next train departing 24th Street to EAST BAY: </h2><ul class="destinations">';

    let timesSF =
      '<h2>Next train departing 24th Street to SF: </h2><ul class="destinations">';
